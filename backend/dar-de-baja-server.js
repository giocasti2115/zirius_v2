...
app.get('/api/v1/dar-de-baja/public', async (req, res) => {
    ...
    `;
        ...
        console.log(`✅ [Dar de Baja] Obtenidas: ${solicitudes.length} de ${total} total`);
        // Formatear fechas
...
app.post('/api/v1/dar-de-baja/public', async (req, res) => {
    try {
        ...
        const { codigo_equipo, nombre_equipo, tipo_equipo, marca, modelo, numero_serie, ubicacion_actual, estado_fisico, tipo_baja, motivo_baja, valor_libros, valor_recuperable_estimado, usuario_solicitante, observaciones } = req.body;
