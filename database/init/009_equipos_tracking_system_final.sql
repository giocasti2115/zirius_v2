...
CREATE TABLE IF NOT EXISTS equipos_mantenimientos (
    ...
    FOREIGN KEY (usuario_inicio_id) REFERENCES users(id) ON DELETE SET NULL,
    FOREIGN KEY (usuario_finalizacion_id) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS equipos_alertas (
    ...
    FOREIGN KEY (equipo_id) REFERENCES equipos(id) ON DELETE CASCADE,
    FOREIGN KEY (usuario_creacion_id) REFERENCES users(id) ON DELETE SET NULL,
    FOREIGN KEY (usuario_resolucion_id) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE INDEX idx_equipos_updated_at ON equipos(updated_at);
